...
@Component({
  selector: 'kt-delegitaires',
  templateUrl: './delegitaires.component.html',
  styleUrls: ['./delegitaires.component.scss']
})
export class DelegitairesComponent implements OnInit {
  ...
  addAssociation(): void {
	this.router.navigate(["pages/delegitaire/add-delegitaire"]);
}
UpdAssociation(): void {
	this.router.navigate(["pages/delegitaire/upd-delegitaire"]);
}
DettailleAssociation(): void {
	this.router.navigate(["pages/delegitaire/detaille-delegitaire"]);
}
